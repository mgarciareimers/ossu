...
# Python program similar to http://www.py4e.com/code3/urllink2.py. The program will use 
...
# Actual data: http://py4e-data.dr-chuck.net/comments_1450811.html (Sum ends with 59)
#
...
# and sum the numbers.
# Look at the sample code provided (in python2). It shows how to find all of a certain 
